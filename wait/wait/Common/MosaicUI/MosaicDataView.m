...
-(void)setModule:(MosaicData *)newModule{
    module = newModule;
    __block UIImage *anImage = [[UIImage alloc]init];
    self.imageView.alpha = 0;
    NSURL *url = [NSURL URLWithString:module.imageUrl];
    [self.imageView sd_setImageWithURL:url completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
        ...
        self.imageView.frame = CGRectMake(0, 0, imgFinalSize.width, imgFinalSize.height);
